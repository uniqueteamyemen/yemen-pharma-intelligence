...
- [ ] إجراء اختبار شامل لصفحة /dashboard/offers واستجابات tRPC وتدفق إنشاء العرض
...
- [ ] الحصول على ترخيص أو بيانات مصدر مرخصة للأسماء التجارية قبل ربطها بالكتالوج
- [ ] تنفيذ اختبار قبول إنشاء العرض بحساب وجهة حقيقي بعد 25 أغسطس
